...
const createItems = () => {
	for(let i=1; i<=30; i++){
		...
		img.setAttribute("src",`whale-game-js/imgs/icons/${i}.png`);
...
const showSelectedImage = () => {
	...
	gameTarget.innerHTML = `<img src="whale-game-js/imgs/icons/${randomNum}.png" id="game__target__img" data-num="${randomNum}">`;
}
